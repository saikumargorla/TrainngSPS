...
$sql= "select party.id as id,party.name as name,address1,email,address2,phone1,phone2,url,city,state,zip,country.value1 as country,language.Value1 as language  from party
	left outer join SystemOptions country on party.Country=country.id 
	left outer join SystemOptions language on party.language=language.ID where PartyType='supplier'  order by party.id  ";
